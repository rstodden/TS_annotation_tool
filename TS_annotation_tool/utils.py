...
from settings_annotation.config_error_analysis import error_analysis_dict, error_operation_list, tuple_list_choices_error_operation, tuple_list_choices_error_suboperation, tuple_list_error_operation_level, list_choices_error_suboperation
