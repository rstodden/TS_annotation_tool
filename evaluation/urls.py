...
urlpatterns = [
    ...
    path('aligned_document_sentences_export', views.aligned_document_sentences_export, name="aligned_document_sentences_export"),
    path('export_text_leveling_data', views.export_text_leveling_data, name="export_text_leveling_data"),
